            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-grow">
                ...
                <div className="flex flex-wrap gap-4 items-center">
                  ...
                  <a
                    href="https://atlantic-liart.vercel.app/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-8 py-4 bg-white text-black font-black rounded-xl uppercase tracking-widest transition-all hover:bg-gray-200 hover:scale-105 shadow-[0_0_20px_rgba(255,255,255,0.3)] flex items-center gap-2 group"
                  >
                    <span className="group-hover:rotate-12 transition-transform">🛒</span>
                    {t('fr') === 'fr' ? 'Accéder à la Boutique Démo' : 'View Demo Shop'}
                  </a>
                </div>
              </div>
            </div>
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-8 py-4 bg-[#5865F2] text-white font-black rounded-xl uppercase tracking-widest transition-all hover:brightness-110 hover:scale-105 shadow-[0_0_25px_rgba(88,101,242,0.2)] flex items-center gap-2"
              >
                <span>💬</span> {t('shop.joinDiscord')}
              </a>
            </div>
          </motion.div>
        </div>
