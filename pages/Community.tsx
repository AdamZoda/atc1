    ...
    >
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            { name: "Discord", icon: MessageSquare, link: siteConfig.links.discord, color: "hover:bg-[#5865F2]", sub: "Discussions & Support" },
            { name: "Twitter", icon: Twitter, link: siteConfig.links.twitter, color: "hover:bg-[#1DA1F2]", sub: "Dernières actualités" },
            { name: "Instagram", icon: Instagram, link: siteConfig.links.instagram, color: "hover:bg-gradient-to-tr hover:from-yellow-400 hover:via-red-500 hover:to-purple-500", sub: "Coulisses & Photos" },
            { name: "YouTube", icon: Youtube, link: siteConfig.links.youtube, color: "hover:bg-[#FF0000]", sub: "Trailers & Guides" }
          ].map((social, i) => (
            <motion.a
              key={i}
              href={social.link}
            ...
            >
              <social.icon size={48} className="text-luxury-gold group-hover:text-white transition-colors mb-6" />
        ...
        <section className="mt-24 glass rounded-[3rem] overflow-hidden">
          <div className="flex flex-col lg:flex-row items-stretch">
            ...
            <div className="lg:w-1/2 bg-white/5 relative min-h-[400px]">
              <img 
                src="https://picsum.photos/seed/community-rp/800/800" 
                alt="Community life" 
