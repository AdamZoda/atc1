          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-gray-400 text-lg max-w-3xl mx-auto">
                Welcome to Atlantic RP, an immersive server where authenticity and community are at the heart of the experience. Join thousands of players crafting unforgettable stories in a rich, detailed universe. Our dedicated staff ensures a fair and welcoming environment for everyone.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="relative py-16 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <motion.div
              ...
              className="glass p-8 rounded-[2rem] border border-white/5 text-center"
            >
              <div className="text-4xl font-bold text-luxury-gold mb-2">18 000+</div>
              ...
              <div className="flex flex-col items-center gap-5">
                ...
                {[1, 2, 3, 4, 5, 6, 7].map((priority) => {
                  ...
                  const levelColors = {
                    ...
                    7: { border: 'border-gray-500', text: 'text-gray-300' }
                  };
                        ...
                        >
                          <div className={`relative p-3 rounded-xl border-2 ${levelColors[priority as keyof typeof levelColors].border} bg-black/60 backdrop-blur-sm group-hover:border-luxury-gold transition-all hover:scale-105`}>
                            <div className="aspect-square mb-2 rounded-lg overflow-hidden border border-white/10">
                              <img
                                src={admin.avatar_url || 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?w=400'}
                                alt={admin.username}
                                ...
                                onError={(e) => {
                                  ...
                                  target.src = 'https://i.postimg.cc/rF1jc0R2/depositphotos-51405259-stock-illustration-male-avatar-profile-picture-use.jpg';
                                }}
                              />
                            </div>
                  ...
                  <div className="md:col-span-1 space-y-2 max-h-[400px] overflow-y-auto">
                    {userTickets.map((ticket) => (
                      <button
                        ...
                        className={`w-full text-left p-3 rounded-lg text-sm transition-all border ${selectedUserTicket?.id === ticket.id
                      ...
                      >
                        ...
                        <span className={`inline-block px-2 py-1 rounded text-xs font-bold mt-1 ${ticket.status === 'OUVERT' ? 'bg-yellow-500/20 text-yellow-400' :
