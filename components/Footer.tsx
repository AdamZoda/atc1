      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            <h2 className="font-cinzel text-2xl font-black text-luxury-gold mb-6 tracking-widest">ATLANTIC RP</h2>
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400 text-sm">
              <li><Link to="/" className="hover:text-luxury-gold transition-colors">Accueil</Link></li>
              <li><Link to="/features" className="hover:text-luxury-gold transition-colors">Fonctionnalités</Link></li>
              <li><Link to="/rules" className="hover:text-luxury-gold transition-colors">Règlement</Link></li>
              <li><Link to="/media" className="hover:text-luxury-gold transition-colors">Galerie</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            >
              Rejoindre notre Discord officiel
            </a>
          </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-gray-500 font-medium">
            &copy; {new Date().getFullYear()} Atlantic RP. Tous droits réservés. Design by FiveM Experts.
          </p>
          <div className="flex gap-6 text-[10px] uppercase font-bold text-gray-500 tracking-widest">
            ...
            <a href="#" className="hover:text-luxury-gold">Contact</a>
          </div>
        </div>
      </div>
    </footer>
