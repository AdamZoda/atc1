-- ============================================
-- VÉRIFICATION DES TABLES DE MUSIQUE
-- ============================================
-- Exécutez ce script dans Supabase SQL Editor pour vérifier les tables
...
-- 4️⃣ AFFICHER LA STRUCTURE DE LA TABLE admin_logs
SELECT 
  column_name,
  data_type,
  is_nullable,
